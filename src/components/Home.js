   ...
   const homejsx=(
        ...
        <div className="banner">
            ...
            <div className="title first-name">Hello There...</div>
                <div className="title surname">I'm <span className="name">P Dinesh Kumar</span></div>
        ...
        <div className="scroll-down"><h4 className="bounce">Scroll Down <FaAngleDoubleDown/></h4></div>
        </div>
